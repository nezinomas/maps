...
urlpatterns = [
    ...
    path('<slug:trip>/update_all_tracks/', views.RewriteAllTracks.as_view(), name='update_all_tracks'),
    path('<slug:trip>/update_points/', views.SaveNewPoints.as_view(), name='update_points'),
    path('<slug:trip>/regenerate_points_file/', views.RegeneratePointsFile.as_view(), name='regenerate_points_file'),
