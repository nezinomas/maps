from .tcx import Activity, ActivityLap, Trackpoint
import requests
import uuid
import socket
import datetime
...
class Endomondo:
    ...
    def call(self, url, format, params={}):
        ...
        r = self.request.get('http://api.mobile.endomondo.com/mobile/' + url, params=params)
...
class EndomondoWorkout:
    ...
    def get_activity(self):
        ...
        l.distance_km = to_float(data[8])
        l.maximum_speed = to_float(data[10])
